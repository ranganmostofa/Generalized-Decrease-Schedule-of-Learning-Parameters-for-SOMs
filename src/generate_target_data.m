...
%         human activity dataset to ../dataset/target_data.mat file.
%%
%   
    f_X = fopen('../dataset/FCPS/01FCPSdata/Target.lrn','rt');
    f_Y = fopen('../dataset/FCPS/01FCPSdata/Target.cls','rt');
